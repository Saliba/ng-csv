...
describe('ngCsv directive', function () {
  ...
  it('Creates a header row if provided', function (done) {
    ...
    scope.buildCSV(scope.data).then(function() {
      expect(scope.csv).toBe('data:text/csv;charset=utf-8,%ef%bb%bfA,B,C%0D%0A1,2,3%0D%0A4,5,6%0D%0A');
      done();
    });
    scope.$apply();
  });
  ...
  it('Accepts optional text-delimiter attribute (input array)', function (done) {
    ...
    scope.buildCSV(scope.data).then(function() {
      expect(scope.csv).toBe('data:text/csv;charset=utf-8,%ef%bb%bf1,%22a%22,2%0D%0A%22b%22,%22c%22,3%0D%0A');
      done();
    });
    scope.$apply();
  });
  ...
  it('Handles commas in fields properly', function (done) {
    ...
    scope.buildCSV(scope.data).then(function() {
      expect(scope.csv).toBe('data:text/csv;charset=utf-8,%ef%bb%bf1,%22a%2Cb%22,2%0D%0Ab,c,3%0D%0A');
      done();
    });
    scope.$apply();
  });
  ...
  it('Handles CLR in fields properly', function (done) {
    ...
    scope.buildCSV(scope.data).then(function() {
      expect(scope.csv).toBe('data:text/csv;charset=utf-8,%ef%bb%bf1,%22a%0Ab%22,2%0D%0Ab,c,3%0D%0A');
      done();
    });
    scope.$apply();
  });
  ...
  it('Handles # in fields properly', function (done) {
    ...
    scope.buildCSV(scope.data).then(function() {
      expect(scope.csv).toBe('data:text/csv;charset=utf-8,%ef%bb%bf1,a%23b,2%0D%0Ab,c,3%0D%0A');
      done();
    });
    scope.$apply();
  });
